...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "best_1007_23580"
...
#define AI_NETWORK_IN_1_HEIGHT      (625)
#define AI_NETWORK_IN_1_CHANNEL     (1)
#define AI_NETWORK_IN_1_SIZE        (625 * 1)
#define AI_NETWORK_IN_1_SIZE_BYTES  (2500)
